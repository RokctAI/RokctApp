import 'package:hardware_sdk/src/printer/printer_manager.dart';
import 'dart:async';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:core_sdk/core_sdk.dart';
import 'package:hardware_sdk/src/printer/printer.dart';
import 'package:hardware_sdk/src/printer/providers/billing_printer_state.dart';
...
class BillingPrinterNotifier extends StateNotifier<BillingPrinterState> {
  ...
  void init() {
    final mac = CoreLocalStorage.getPrinterMac();
    final name = CoreLocalStorage.getPrinterName();
  ...
  Future<void> connect(String mac, String name) async {
    ...
    if (response.isSuccess) {
      CoreLocalStorage.setPrinterMac(mac);
      CoreLocalStorage.setPrinterName(name);
      state = state.copyWith(
  ...
  Future<void> disconnect() async {
    ...
    if (response.isSuccess) {
      CoreLocalStorage.removePrinterMac();
      CoreLocalStorage.removePrinterName();
      state = state.copyWith(

...
import 'package:users_sdk/src/models/response/wallet_histories_response.dart';
import 'package:users_sdk/src/models/response/pages_response.dart';
import 'package:users_sdk/src/models/response/blog_response.dart';
import 'package:users_sdk/src/models/response/career_response.dart';
import 'package:users_sdk/src/models/data/career_data.dart';
import 'package:users_sdk/src/models/data/links.dart';
import 'package:users_sdk/src/models/data/address_new_model.dart';
import 'package:users_sdk/src/models/data/referral_data.dart';
import 'package:users_sdk/src/models/response/profile_response.dart';
...
class UserRepository implements UserRepositoryFacade {
  ...
  final dynamic Function()? _getLanguage;
  final Future<void> Function()? _logoutStorage;
  ...
  Future<ApiResult<CareerData>> getCareerData(int id) async {
    final data = {"lang": _getLanguage?.call()?.locale ?? "en"};
    try {
      final client = _dio;
      final response = await client.get(

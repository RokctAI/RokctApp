...
import 'package:merchants_sdk/src/presentation/pages/main/foods/create/details/add_category_modal.dart';
    ...
    return ModalWrap(
      body: Column(
        children: [
          ...
          16.verticalSpace,
          Divider(color: AppStyle.toggle, height: 1.r, thickness: 1.r),
          24.verticalSpace,
          Expanded(
            child: Padding(

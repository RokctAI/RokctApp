import 'package:orders_sdk/src/driver/models/data/push_data.dart';

import 'package:orders_sdk/src/driver/models/data/product_data.dart';
...
class OrderDetailData {
  ...
  OrderDetailData.fromJson(Map<String, Dyn> json) {
    ...
    currency = json['currency'] != null
        ...
        : null;
    user = json['user'] != null ? OrderUserData.fromJson(json['user']) : null;
...
class OrderUserData {
  ...
  OrderUserData.fromJson(Map<String, Dyn> json) {
    id = json['id'];
    uuid = json['uuid'];

...
class MerchantData implements MerchantEntity {
  MerchantData({
    this.id,
    this.uuid,
    this.userId,
  ...
  @override
  String? get logoUrl => logoImg;

  @override
  String? get bannerUrl => backgroundImg;

  @override
  bool? get isActive => verify;

  @override
  MerchantType get type {
    if (shopType == 'restaurant') return MerchantType.restaurant;
    if (shopType == 'company') return MerchantType.company;
    if (shopType == 'loanprovider') return MerchantType.loanprovider;
    if (shopType == 'tenant') return MerchantType.tenant;

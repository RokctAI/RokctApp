import 'package:products_sdk/src/models/data/addons_data.dart';
...
class Galleries {
  ...
  factory Galleries.fromJson(Map<String, Dyn> json) => Galleries(
    id: json["id"]?.toString(),
...
class ReviewData {
  ...
  factory ReviewData.fromJson(Map<String, Dyn> json) => ReviewData(
    id: json["id"]?.toString(),

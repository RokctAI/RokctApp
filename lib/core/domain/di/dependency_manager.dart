...
Future<void> setUpDependencies() async {
  ...
  getIt.registerSingleton<driver_orders.DriverOrdersRepository>(
    driver_orders_impl.OrdersRepository(),
  );
  getIt.registerSingleton<driver_parcel.DriverParcelRepository>(
    driver_parcel_impl.ParcelRepository(),
  );
  getIt.registerSingleton<driver_notif.DriverNotificationRepository>(
...
driver_orders.DriverOrdersRepository get DriverOrdersRepository =>
    getIt.get<driver_orders.DriverOrdersRepository>();
driver_parcel.DriverParcelRepository get DriverParcelRepository =>
    getIt.get<driver_parcel.DriverParcelRepository>();
driver_notif.DriverNotificationRepository get DriverNotificationRepository =>
    getIt.get<driver_notif.DriverNotificationRepository>();

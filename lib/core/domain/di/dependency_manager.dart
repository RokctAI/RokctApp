...
// Driver Interfaces
import 'package:rokctapp/driver/domain/interface/notification.dart' as driver_notif_int;
import 'package:rokctapp/driver/domain/interface/parcel.dart' as driver_parcel_int;
import 'package:rokctapp/driver/domain/interface/orders.dart' as driver_orders_int;
...
// Manager Interfaces
import 'package:rokctapp/manager/domain/interface/notification.dart' as manager_notif_int;
import 'package:rokctapp/manager/domain/interface/payment_facade.dart' as manager_payment_int;
import 'package:rokctapp/manager/domain/interface/subscription_facade.dart' as manager_sub_int;
import 'package:rokctapp/manager/domain/interface/table.dart' as manager_table_int;
...
Future<void> setUpDependencies() async {
  ...
  getIt.registerSingleton<manager_table_int.TableInterface>(manager_table_impl.TableRepository());
  ...
  getIt.registerSingleton<manager_notif_int.NotificationInterface>(manager_notif_impl.NotificationRepository());
  getIt.registerSingleton<manager_payment_int.PaymentsFacade>(manager_payment_impl.PaymentRepository());
  getIt.registerSingleton<manager_sub_int.SubscriptionsFacade>(manager_sub_impl.SubscriptionsRepository());
}
...
driver_orders_int.DriverOrdersRepository get driverOrdersRepository => getIt.get<driver_orders_int.DriverOrdersRepository>();
driver_parcel_int.DriverParcelRepository get driverParcelRepository => getIt.get<driver_parcel_int.DriverParcelRepository>();
driver_notif_int.DriverNotificationRepository get driverNotificationRepo => getIt.get<driver_notif_int.DriverNotificationRepository>();
...
manager_table_int.TableInterface get managerTableRepository => getIt.get<manager_table_int.TableInterface>();
...
manager_notif_int.NotificationInterface get managerNotificationRepository => getIt.get<manager_notif_int.NotificationInterface>();
manager_sub_int.SubscriptionsFacade get managerSubscriptionRepository => getIt.get<manager_sub_int.SubscriptionsFacade>();
manager_payment_int.PaymentsFacade get managerPaymentRepositoryNew => getIt.get<manager_payment_int.PaymentsFacade>();

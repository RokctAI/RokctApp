...
import 'package:rokctapp/core/presentation/pages/home/filter/result_filter.dart';
import 'package:rokctapp/core/presentation/pages/home/home_two/widget/recommended_two_screen.dart';
...
import 'package:rokctapp/core/presentation/pages/home/home_one/widget/recommended_one_screen.dart';
import 'package:rokctapp/core/presentation/pages/home/home_three/widgets/recommended_three_screen.dart';
...
import 'package:rokctapp/core/presentation/pages/like/like_page.dart';
import 'package:rokctapp/core/presentation/pages/main/main_page.dart';
import 'package:rokctapp/core/presentation/pages/order/order_screen/order_screen.dart';
import 'package:rokctapp/core/presentation/pages/order/orders_page.dart';
import 'package:rokctapp/core/presentation/pages/parcel/parcel_list_page.dart';
import 'package:rokctapp/core/presentation/pages/parcel/parcel_order_page.dart';
import 'package:rokctapp/core/presentation/pages/parcel/widgets/info_screen.dart';
...
import 'package:rokctapp/core/presentation/pages/profile/address_list.dart';
import 'package:rokctapp/presentation/pages/profile/notification_page.dart';
import 'package:rokctapp/core/presentation/pages/profile/profile_page.dart';
import 'package:rokctapp/core/presentation/pages/profile/share_referral_faq.dart';
import 'package:rokctapp/core/presentation/pages/search/search_page.dart';
import 'package:rokctapp/core/presentation/pages/service/service_two_category_page.dart';
import 'package:rokctapp/core/presentation/pages/setting/setting_page.dart';
import 'package:rokctapp/core/presentation/pages/shop/shop_detail.dart';
import 'package:rokctapp/core/presentation/pages/shop/shop_page.dart';
import 'package:rokctapp/core/presentation/pages/view_map/map_search_page.dart';
import 'package:rokctapp/core/presentation/pages/view_map/view_map_page.dart';
import 'package:rokctapp/core/infrastructure/models/data/address_new_data.dart';
import 'package:rokctapp/core/infrastructure/models/data/shop_data.dart';
...
import 'package:rokctapp/core/presentation/pages/home/widgets/shops_banner_page.dart';
import 'package:rokctapp/core/presentation/pages/initial/location/permission_location.dart';
import 'package:rokctapp/core/presentation/pages/order/order_screen/order_progress_screen.dart';
import 'package:rokctapp/core/presentation/pages/parcel/parcel_page.dart';
import 'package:rokctapp/core/presentation/pages/profile/become_seller/create_shop.dart';
import 'package:rokctapp/core/presentation/pages/profile/help_page.dart';
import 'package:rokctapp/core/presentation/pages/home/widgets/recommended_screen.dart';
import 'package:rokctapp/core/presentation/pages/profile/share_referral_page.dart';
import 'package:rokctapp/core/presentation/pages/profile/wallet_history.dart';

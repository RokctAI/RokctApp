...
Source file: `lib/manager/presentation/pages/restaurant/notification_list_page.dart`

## Classes

### class `ManagerNotificationListPage`

## Whitelisted API Endpoints

### `ManagerNotificationListPage({super.key}); @override ConsumerState<ManagerNotificationListPage> createState() => _NotificationListPageState(); } class _NotificationListPageState extends ConsumerState<ManagerNotificationListPage> { final bool isLtr = LocalStorage.getLangLtr(); late RefreshController refreshController; @override void initState()`
